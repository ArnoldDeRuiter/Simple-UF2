...
unsigned long LONG_PRESS_TRIGGER = 2000;
...
void firstboot() {
//Sanity check
if (UNWRITTEN_PAYLOAD_NUMBER > 8 || WRITTEN_PAYLOAD_NUMBER > 8){
  UNWRITTEN_PAYLOAD_NUMBER = 1;
    WRITTEN_PAYLOAD_NUMBER = 1;
}

if (UNWRITTEN_MODE_NUMBER > 4 || WRITTEN_MODE_NUMBER > 4){
  UNWRITTEN_MODE_NUMBER = 1;
    WRITTEN_MODE_NUMBER = 1;
}

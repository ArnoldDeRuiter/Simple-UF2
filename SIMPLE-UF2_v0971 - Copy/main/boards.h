...
#define GREENLED 8
#define BLUELED 2
#define GOODBATT 900 // 10-bit value. Min 0, Max 1023. 1023 approx equal to 1100mV. Above GOODBATT = Green battLED
#define FLATBATT 100 //860 // 10-bit value. Min 0, Max 1023. Above FLATBATT but below GOODBATT = Amber battLED. Under FLATBATT, sleep(-1), disable MCU
//#define MODE_CHANGE_PIN 4 // Irrelevant
//#define ONBOARD_LED 13 // Irrelevant
